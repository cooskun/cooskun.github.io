...
module.exports = "<h1 class=\"app-title\">{{title}}</h1>\r\n\r\n<nav class=\"navbar\">\r\n    <a routerLink=\"/dashboard\">DASHBOARD</a>\r\n    <a routerLink=\"/heroes\">HEROES</a>\r\n</nav>\r\n\r\n<!-- Wrapper for heroes components -->\r\n<router-outlet></router-outlet>\r\n\r\n<!-- Messages Component -->\r\n<app-messages></app-messages>"
...
module.exports = "<div *ngIf=\"hero\" class=\"hero-detail\">\r\n  <h2>{{hero.name | uppercase}} Details</h2>\r\n  <div class=\"hero-detail__details\">\r\n    <p>\r\n      <span>Id : </span>{{hero.id}}</p>\r\n    <p>\r\n      <span>Name : </span>{{hero.name}}</p>\r\n  </div>\r\n  <div>\r\n    <input [(ngModel)]=\"hero.name\" placeholder=\"name\">\r\n  </div>\r\n</div>\r\n\r\n<button (click)=\"goBack()\" *ngIf=\"url != '/heroes' && url != '/tour-of-heroes/heroes'\">go back</button>"
...
var HeroDetailComponent = /** @class */ (function () {
    ...
    HeroDetailComponent.prototype.ngAfterContentInit = function () {
    ...
    HeroDetailComponent.prototype.logEvent = function (event) {
        console.log(event);
    };
    __decorate([
    ...
    HeroDetailComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            ...
            styles: [__webpack_require__("../../../../../src/app/hero-detail/hero-detail.component.css"), __webpack_require__("../../../../../src/app/app.component.css")]
        }),
...
var HeroService = /** @class */ (function () {
    //  I can fetch to MessageService functions anymore such as add(), clear()
    function HeroService(messageService) {
        this.messageService = messageService;
        this.heroesUrl = 'api/heroes'; // URL to web api
    }
    HeroService.prototype.getHeroes = function () {
        //  I use the add() function from MessageService
    ...
    HeroService.prototype.getHero = function (id) {
        ...
        return __WEBPACK_IMPORTED_MODULE_1__heroes__["a" /* HEROES */].find(function (hero) { return hero.id === id; });
    };
